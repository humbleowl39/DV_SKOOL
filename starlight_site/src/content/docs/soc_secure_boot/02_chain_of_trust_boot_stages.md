---
title: "Module 02 — Chain of Trust & Boot Stages"
---
...
:::
:::note[사전 지식]
- [Module 01](../01_hardware_root_of_trust/) — HW RoT, OTP, ROTPK
...
자세한 키 계층 분석은 [Module 03](../03_crypto_in_boot/) 에서.
...
:::tip[🤔 Q1 — BL1 ROM 화 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Measured vs Verified (Bloom: Evaluate)]
...
- 📝 [**Module 02 퀴즈**](../quiz/02_chain_of_trust_boot_stages_quiz/)
- ➡️ [**Module 03 — Crypto in Boot**](../03_crypto_in_boot/): 위 chain 의 _도장 찍는 도구_ — hash, signature, 키 계층, PQC.
