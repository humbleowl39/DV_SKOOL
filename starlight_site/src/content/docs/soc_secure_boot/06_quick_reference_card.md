...
:::
:::note[사전 지식]
- [Module 01-05](../01_hardware_root_of_trust/) 모두 학습 완료.
:::
---
...
:::caution[실무 주의점 — Anti-rollback counter 가 OTP 가 아닌 OTP-emulated 영역에 위치]
...
- 📝 [**Quick Ref 퀴즈**](../quiz/06_quick_reference_card_quiz/)
- ➡️ [**Module 06 — BootROM DV**](../07_bootrom_dv_methodology/) (DV 방법론)
