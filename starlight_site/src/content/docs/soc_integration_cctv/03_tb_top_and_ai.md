---
title: "Module 03 — TB Top & AI Automation"
---
...
:::
:::note[사전 지식]
- [Module 01-02](../01_soc_top_integration/) — SoC Top 검증의 5 축 + CCTV 매트릭스
...
:::caution[실무 주의점 — AI 생성 시퀀스의 Clock Domain 무시]
...
:::tip[🤔 Q1 — Config-driven TB 설계 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — AI 생성 결과 검증 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q3 — AI 자동화 ROI (Bloom: Evaluate)]
...
→ [Module 04 — Quick Reference Card](../04_quick_reference_card/): 5 축, CCTV 매트릭스, 정량 데이터, 디버그 체크리스트를 한 장에 정리.

[퀴즈 풀어보기 →](../quiz/03_tb_top_and_ai_quiz/)
