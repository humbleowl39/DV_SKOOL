---
title: "Hardware Interview Prep"
---

import { CardGrid, LinkCard } from '@astrojs/starlight/components';

반도체 하드웨어 인터뷰는 단일 전공 지식만으로 통과하기 어렵다. 같은 "CDC(Clock Domain Crossing, 서로 다른 클럭 영역 사이로 신호를 넘기는 일) 신호를 어떻게 넘기나요?"라는 질문이 RTL(Register-Transfer Level, 회로를 레지스터 간 데이터 흐름으로 기술하는 설계 층) 면접에서는 synchronizer 회로로, DV(Design Verification, 설계 검증) 면접에서는 검증 전략으로, PD(Physical Design, 물리 설계) 면접에서는 timing constraint로 변주되어 나오기 때문이다. 한 영역만 깊게 파고 나머지를 비워두면, 면접관이 인접 영역으로 한 발만 넘어가도 답이 막히고 "자기 블록만 아는 사람"이라는 인상을 준다.
...
-   **[Unit 1: Digital Design / RTL](./01_digital_rtl/)**
...
-   **[Unit 2: Design Verification](./02_design_verification/)**
...
-   **[Unit 3: Embedded / Firmware](./03_embedded_firmware/)**
...
-   **[Unit 4: Computer Architecture](./04_computer_architecture/)**
...
-   **[Unit 5: Analog / Mixed-Signal](./05_analog_mixed_signal/)**
...
-   **[Unit 6: Physical Design](./06_physical_design/)**
...
<CardGrid>
	<LinkCard title="Unit 1 — Digital Design / RTL" href="./01_digital_rtl/" />
	<LinkCard title="Unit 2 — Design Verification" href="./02_design_verification/" />
	<LinkCard title="Unit 3 — Embedded Systems / Firmware" href="./03_embedded_firmware/" />
	<LinkCard title="Unit 4 — Computer Architecture / Performance Modeling" href="./04_computer_architecture/" />
	<LinkCard title="Unit 5 — Analog / Mixed-Signal Design" href="./05_analog_mixed_signal/" />
	<LinkCard title="Unit 6 — Physical Design" href="./06_physical_design/" />
</CardGrid>
