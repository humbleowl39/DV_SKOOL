---
title: "Module 04 — Stack & Binary Search"
---
...
:::tip[🤔 잠깐 — Monotonic stack 의 _amortized_?]
...
:::tip[🤔 Q1 — Search rotated sorted array (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Monotonic stack 의 적용 (Bloom: Apply)]
...
→ [Module 05 — Tree & BFS/DFS](../05_tree_bfs_dfs_explained/): 재귀 stack 의 가장 자연스러운 응용 — 트리 탐색 + 명시적 큐 BFS.

[퀴즈 풀어보기 →](../quiz/04_stack_binary_search_explained_quiz/)
