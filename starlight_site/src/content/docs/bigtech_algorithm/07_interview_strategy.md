---
title: "Module 07 — Interview Strategy"
---
...
:::tip[🤔 잠깐 — _Edge case_ 빼먹는 가장 흔한 실수?]
...
위 키워드→패턴 대응은 Module 01~06 에서 다룬 것이고, **Backtracking**(되추적 — 후보를 하나씩 추가하며 끝까지 시도해 보고, 막히면 마지막 선택을 취소(undo)하고 다른 가지를 탐색하는 완전 탐색 기법)만 이 표에서 처음 등장합니다.
...
:::tip[🤔 Q1 — 45 분 면접 time budget (Bloom: Apply)]
...
[퀴즈 풀어보기 →](../quiz/07_interview_strategy_quiz/)
