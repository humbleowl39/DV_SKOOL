---
title: "Module 02 — SVA (SystemVerilog Assertions)"
---
...
:::
:::note[사전 지식]
- [Module 01 — Formal Fundamentals](../01_formal_fundamentals/) — property / cover / induction 의 의미
...
S1: "① Spec 읽기: valid==1 && ready==0 → 다음 cycle data 동일"
S2: "② SVA 작성: (valid && !ready) |=> (valid && \$stable(data))"
S3: "③ Cover 짝: cp_stall / cp_stall_chain [*3]"
S4: "④ Bind: bind axi_master axi_sva u_sva (.*)"
S5: "⑤ JG 실행: analyze → elaborate → clock/reset → prove -all"
S6: "⑥ 결과 분류: PROVEN / BOUNDED / CEX / cover: trace 1"
S7: "⑦ Sign-off: PROVEN + cover covered → 의미 있는 증명"
S1 -> S2
S2 -> S3
S3 -> S4
S4 -> S5
...
:::caution[실무 주의점 — Vacuous Pass (cover 누락)]
...
:::
:::tip[🤔 Q2 — Implication 선택 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q3 — Disable condition (Bloom: Evaluate)]
...
→ [Module 03 — JasperGold & DV Strategy](../03_jaspergold_and_strategy/): SVA 가 Formal 도구에서 어떻게 PROVEN 으로 가는지 — Convergence 전략, Blackbox/Cut Point, Sign-off 5가지 기준.

[퀴즈 풀어보기 →](../quiz/02_sva_quiz/)
