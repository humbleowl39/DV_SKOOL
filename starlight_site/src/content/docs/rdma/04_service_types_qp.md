---
title: "Module 04 — Service Types & QP FSM"
---
...
→ 자세한 흐름은 [Module 06 Data Path](../06_data_path/) 와 [Module 07 Error](../07_congestion_error/) 에서.
...
이 시나리오들은 [Module 08 RDMA-TB DV](../08_rdma_tb_dv/) 에서 vplan 과 매핑됨.
...
:::tip[🤔 Q1 — Service type 선택 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — QP FSM 디버그 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q3 — RTS 진입 후 동작 (Bloom: Evaluate)]
...
→ [Module 05 — Memory Model: PD/MR/L_Key/R_Key/IOVA](../05_memory_model/): MR 등록과 보호 키, IOVA 변환의 동작 원리.

[퀴즈 풀어보기 →](../quiz/04_service_types_qp_quiz/)
