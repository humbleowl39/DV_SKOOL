...
:::tip[🤔 Q1 — Lab fail 진단 순서 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — Sim ↔ Lab 분리 (Bloom: Evaluate)]
RDMA-TB scoreboard 를 설계할 때, lab 의 _adaptive routing_ 이 RC packet 을 _OOO_ 로 도착시키는 상황이 있습니다. Scoreboard 가 이를 sim 시나리오와 어떻게 분리하여 처리해야 하나요?
...
→ [Module 13 — Background & Industry Research](../13_background_research/)

[퀴즈 풀어보기 →](../quiz/12_fpga_proto_manuals_quiz/)
