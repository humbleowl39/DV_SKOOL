---
title: "Module 07 — Congestion Control & Error Handling"
---
...
:::caution[ACK 가 retry_cnt 를 *복원하지 않음*]
...
:::tip[🤔 Q1 — PFC deadlock 분석 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — `WC_RETRY_EXC_ERR` 원인 분리 (Bloom: Apply)]
...
:::
:::tip[🤔 Q3 — RDMA-TB error 시나리오 설계 (Bloom: Evaluate)]
...
→ [Module 08 — RDMA-TB 검증 환경 & DV 전략](../08_rdma_tb_dv/): 지금까지 본 모든 개념이 RDMA-TB 의 어떤 컴포넌트에서 어떻게 구현되는지.

[퀴즈 풀어보기 →](../quiz/07_congestion_error_quiz/)
