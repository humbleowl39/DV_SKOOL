---
pagefind: false
title: "Module 11 — GPUBoost / RDMA-IP Hardware Architecture"
---
...
:::caution[1 cycle II 차이가 throughput 0 으로 수렴할 수 있다 (id=1276379157)]
...
:::tip[🤔 Q1 — Wrapper 책임 분리 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — HLS II bottleneck (Bloom: Analyze)]
...
→ [Module 12 — FPGA Prototyping & Lab Manuals](../12_fpga_proto_manuals/)

[퀴즈 풀어보기 →](../quiz/11_gpuboost_rdma_ip_quiz/)
