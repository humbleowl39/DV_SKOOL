...
| 시맨틱 API | Verbs | libfabric (OpenFabrics 의 차세대 통신 API — Verbs 보다 MPI(Message Passing Interface, 병렬 프로그램의 노드 간 통신 표준)/collective 친화) |
...
:::tip[🤔 잠깐 — UEC 가 RoCEv2 를 _완전 대체_ 할까?]
...
:::tip[🤔 Q1 — Ordering 가정 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Multipath spray (Bloom: Apply)]
...
→ [Module 11 — GPUBoost / RDMA IP Hardware Architecture](../11_gpuboost_rdma_ip/)

[퀴즈 풀어보기 →](../quiz/10_ultraethernet_quiz/)
