---
title: "Ch07. Deep Dive — DLL Real Number Modeling"
---
...
DLL과 PLL은 자주 한 chip에 같이 들어옵니다. 본 챕터의 DLL deep dive와 짝을 이루는 PLL 모델·시나리오·coverage는 [Appendix D §1 (PLL)](../appendix_d_analog_ip_catalogue/#1-pll--phase-locked-loop)에 있습니다. **검증 관점에서 두 IP의 차이**를 한 페이지로 정리:
...
- 다음: [Ch08. Deep Dive — IO Buffer · IBIS-AMI](../08_deepdive_io_buffer_rnm/)
