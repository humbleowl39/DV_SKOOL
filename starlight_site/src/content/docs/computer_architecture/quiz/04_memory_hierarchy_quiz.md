---
title: "Quiz — Module 04: 메모리 계층 (Cache & DRAM)"
---

[← Module 04 본문으로 돌아가기](../../04_memory_hierarchy/)
...
**B**. Compulsory(cold, 블록의 첫 접근 — 불가피), Capacity(working set 이 캐시 용량을 초과), Conflict(두 블록이 같은 set 에 매핑되어 반복 축출). conflict miss 는 associativity 를 높이면 줄고 full associativity 로 제거됩니다. D 는 데이터 해저드(M02)로 캐시 miss 와 무관합니다.
