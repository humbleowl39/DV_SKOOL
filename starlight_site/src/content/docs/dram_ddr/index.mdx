...
:::tip[HBM 을 목표로 왔다면]
이 코스는 **LPDDR5 중심**이며 셀의 물리(charge sharing·센스앰프 latch)를 소자 수준까지 다룹니다. HBM 이 목표라면 [HBM 기초](../hbm_basics/)가 더 짧은 경로입니다 — DRAM 원리 중 HBM 이해에 필요한 것만 다루고 TSV·인터포저·적층으로 바로 넘어갑니다.

반대로 [HBM 기초 Ch01](../hbm_basics/01_dram_operation/)을 읽고 **왜 그렇게 되는지**가 더 궁금해졌다면 여기 Module 01 이 그 답입니다.
:::
