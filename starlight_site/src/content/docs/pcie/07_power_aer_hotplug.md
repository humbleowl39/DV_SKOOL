---
title: "Module 07 — Power Management, AER, Hot Plug"
---
...
:::
:::note[사전 지식]
- [Module 04 — Data Link Layer & Flow Control](../04_dllp_flow_control/) — ACK/NAK, replay
- [Module 05 — Physical Layer & LTSSM](../05_phy_ltssm/) — L0/L0s/L1/L2 LTSSM
- [Module 06 — Configuration & Enumeration](../06_config_enumeration/) — Capability list, AER/Slot Cap 위치
:::
---
...
:::tip[🤔 Q1 — AER severity 분류 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — ASPM L1 trade-off (Bloom: Evaluate)]
...
→ [Module 08 — SR-IOV, ATS, P2P, CXL](../08_advanced/): production 안정성 위에 올라가는 modern 가상화·확장 기능들.

[퀴즈 풀어보기 →](../quiz/07_power_aer_hotplug_quiz/)
