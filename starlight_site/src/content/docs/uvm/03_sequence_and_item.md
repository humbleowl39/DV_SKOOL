---
title: "Module 03 — Sequence & Sequence Item"
---
...
:::
:::note[사전 지식]
- [Module 01](../01_architecture_and_phase/), [Module 02](../02_agent_driver_monitor/)
...
:::tip[🤔 Q1 — Sequence vs Item (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Virtual Sequence 의 가치 (Bloom: Evaluate)]
...
→ [Module 04 — config_db & Factory](../04_config_db_factory/): 이 챕터에서 type_id::create 로 만든 모든 객체가 _런타임에 다른 타입으로 대체_ 가능한 메커니즘, 그리고 sequence/agent 가 _설정_ 을 받는 표준 채널.

[퀴즈 풀어보기 →](../quiz/03_sequence_and_item_quiz/)
