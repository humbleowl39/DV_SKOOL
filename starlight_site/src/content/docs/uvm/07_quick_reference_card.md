---
title: "Module 07 — Quick Reference Card"
---

:::tip[사용 목적]
이 페이지는 **참조용 치트시트** 입니다. 정독 자료가 아니라 _인터뷰 / 코드 리뷰 / 디버그_ 중에 빠르게 펴보는 용도. 새로 배우는 사람은 [Module 01-06](../01_architecture_and_phase/) 부터 보고 마지막에 이 페이지로 정리.
...
:::
:::note[사전 지식]
- [Module 01-06](../01_architecture_and_phase/) 학습 완료 후 이 카드를 보면 효과 극대화
:::
---
...
면접에서 5 분 안에 답해야 할 때, 코드 리뷰에서 _"이 부분 안티패턴인 것 같은데 어떤 거였더라"_ 의 순간, 디버그 중 _"raise/drop 의 정확한 패턴이 뭐였더라"_ 의 순간 — 이 한 페이지로 즉시 해결. 각 절은 Module 01-06 의 특정 섹션과 연결되어 있으므로, 한 줄 요약으로 답이 부족하면 연결된 본문으로 바로 이동하면 됩니다.
