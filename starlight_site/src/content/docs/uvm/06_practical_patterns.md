...
:::
:::note[사전 지식]
- [Module 01-05](../01_architecture_and_phase/) 전체
...
:::tip[🤔 Q1 — Sequence `#delay` 금지 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Objection raise/drop 위치 (Bloom: Evaluate)]
