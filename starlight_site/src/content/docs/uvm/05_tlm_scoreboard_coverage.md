---
title: "Module 05 — TLM, Scoreboard, Coverage"
---
...
:::
:::note[사전 지식]
- [Module 01-04](../01_architecture_and_phase/)
...
:::tip[🤔 Q1 — Analysis Port 1:N (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Scoreboard `check_phase` (Bloom: Evaluate)]
...
→ [Module 06 — 실무 패턴 & 안티패턴](../06_practical_patterns/): 지금까지 배운 컴포넌트 / 메커니즘들을 _실제 환경 구축_ 에 어떻게 조립하는가, 그리고 _하면 안 되는_ 패턴들.

[퀴즈 풀어보기 →](../quiz/05_tlm_scoreboard_coverage_quiz/)
