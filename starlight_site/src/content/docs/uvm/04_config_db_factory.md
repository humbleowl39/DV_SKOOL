---
title: "Module 04 — config_db & Factory"
---
...
:::
:::note[사전 지식]
- [Module 01](../01_architecture_and_phase/), [Module 02](../02_agent_driver_monitor/), [Module 03](../03_sequence_and_item/)
...
:::tip[🤔 Q1 — config_db get 실패 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — Factory override vs config (Bloom: Evaluate)]
...
→ [Module 05 — TLM, Scoreboard, Coverage](../05_tlm_scoreboard_coverage/): config_db / factory 로 만든 환경에서, monitor 가 수집한 transaction 이 _어떻게 비교되고 어떻게 coverage 로 흡수되는가_.

[퀴즈 풀어보기 →](../quiz/04_config_db_factory_quiz/)
