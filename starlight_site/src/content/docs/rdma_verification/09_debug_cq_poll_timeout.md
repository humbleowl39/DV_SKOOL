...
:::
:::note[사전 지식]
- [Module 03 — Phase & Test Flow](../03_phase_test_flow/) (CQ polling 패턴 3 — `cq_handler.RDMACQPoll`)
- [Module 07 — H2C/C2H QID Reference](../07_h2c_c2h_qid_map/) (QID 14–17 / 8 / 10–11 의 의미)
...
:::tip[🤔 Q1 — Timeout 원인 분기 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — try_cnt vs c2h_tracker active (Bloom: Analyze)]
...
→ [Module 10 — C2H Tracker Error](../10_debug_c2h_tracker/): C2H DMA 가 일어났는데 매칭이 실패할 때.

[퀴즈 풀어보기 →](../quiz/09_debug_cq_poll_timeout_quiz/)
