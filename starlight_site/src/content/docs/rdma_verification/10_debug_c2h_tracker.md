...
- [Module 06 — Error Handling Path](../06_error_handling_path/) (`is_err_qp_registered`)
- [Module 07 — H2C/C2H QID Reference](../07_h2c_c2h_qid_map/) (C2H QID 8/9 의 RESP 의미)
:::
---
...
Q1: "① addr ∈ m_qp_tracker[*][*].pa_queue ?" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
Q2: "② 어느 QP 의 PA 인가?\n(cross-QP 충돌 검사)"
Q3: "③ ordering 검사\nRC: idx==0 / OPS/SR: idx 범위 내" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
Q4: "④ DUT len ≤ cmd.transfer_size ?" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
OK: "OK — 통과" { style.stroke: "#137333"; style.stroke-width: 2 }
GATE: "is_err_qp_registered\n[node][qp] ?" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
SKIP: "silently skip" { style.stroke: "#137333"; style.stroke-width: 2 }
FATAL: "F-C2H-MATCH-0001/0002/0003/0004" { style.stroke: "#c0392b"; style.stroke-width: 3 }
DUMP: "W-C2H-MATCH-0001~0004\n(unprocessed PA dump)" { style.stroke: "#c0392b"; style.stroke-width: 3 }
...
C2H QID 로 원인 분류 ([Module 07](../07_h2c_c2h_qid_map/)):
...
> [Module 06](../06_error_handling_path/) 의 `vrdma_c2h_tracker::err_enabled` 정의 (line 98) 참고.
...
:::tip[🤔 Q1 — Match 가설 분기 (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Zero-length corner case (Bloom: Evaluate)]
...
→ [Module 11 — Unexpected Error CQE](../11_debug_unexpected_err_cqe/): DUT 가 에러 CQE 를 발생시킬 때 RETRY 계열 분기와 `expected_error` promote 패턴.

[퀴즈 풀어보기 →](../quiz/10_debug_c2h_tracker_quiz/)
