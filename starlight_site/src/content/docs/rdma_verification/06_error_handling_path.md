...
:::
:::note[사전 지식]
- [Module 04 — Analysis Port Topology](../04_analysis_port_topology/) (`completed_wqe_ap` 의 ErrQP 게이트)
- [Module 05 — Extension 4원칙](../05_extension_principles/) (Stateless 보존)
...
:::tip[🤔 Q1 — Error gate 선택 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — Expected error timing (Bloom: Analyze)]
...
→ [Module 07 — H2C / C2H QID Reference](../07_h2c_c2h_qid_map/): DMA 인터페이스의 QID 로 어느 서브시스템이 동작했는지 즉시 식별.

[퀴즈 풀어보기 →](../quiz/06_error_handling_path_quiz/)
