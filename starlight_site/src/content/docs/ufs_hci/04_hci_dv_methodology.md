---
title: "Module 04 — HCI DV Methodology"
---
...
:::
:::note[사전 지식]
- [Module 01-03](../01_ufs_protocol_stack/)
...
:::caution[실무 주의점 — Doorbell-Completion ISR race 검증 누락]
...
:::tip[🤔 Q1 — Host vs Device agent (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — Race coverage (Bloom: Analyze)]
...
→ [Module 05 — Quick Reference Card](../05_quick_reference_card/): 면접 / 회의 / 디버그 중에 즉시 떠올려야 하는 핵심 표 한 장.

[퀴즈 풀어보기 →](../quiz/04_hci_dv_methodology_quiz/)
