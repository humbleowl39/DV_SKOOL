...
:::
:::note[사전 지식]
- [Module 01-04](../01_ufs_protocol_stack/) — 이 카드는 _요약_, 본문이 _근거_.
:::
---
...
:::caution[실무 주의점 — Error recovery: abort vs reset 선택 기준]
...
:::tip[🤔 Q1 — Error recovery 5 단계 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — MCQ 의 가치 (Bloom: Evaluate)]
...
4 개 모듈 + Quick Ref 완료. [퀴즈](../quiz/) · [용어집](../glossary/) · 다음 토픽: [DRAM/DDR](../../dram_ddr/) (storage backbone), [UVM](../../uvm/) (검증 인프라).
