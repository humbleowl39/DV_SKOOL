---
title: "Module 02 — HCI Architecture"
---
...
:::
:::note[사전 지식]
- [Module 01](../01_ufs_protocol_stack/)
...
:::caution[실무 주의점 — UTRLDBR 와 UTRLRSR race]
...
:::tip[🤔 Q1 — 32-slot queueing (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — Doorbell ordering (Bloom: Analyze)]
...
→ [Module 03 — UPIU & Command Flow](../03_upiu_command_flow/): UTRD 가 만들어내는 UPIU 들의 종류 (Command / Response / Data-In/Out / Query / Task Mgmt / NOP) 와 각 명령의 multi-UPIU sequence 전개.

[퀴즈 풀어보기 →](../quiz/02_hci_architecture_quiz/)
