---
title: "Module 03 — Secure Boot Connection"
---
...
- [Module 02A — Secure Enclave & TEE Hierarchy](../02a_secure_enclave_and_tee_hierarchy/)
...
:::tip[🤔 Q1 — Lock-down race (Bloom: Analyze)]
...
:::
:::tip[🤔 Q2 — Measured Boot (Bloom: Apply)]
...
:::
:::tip[🤔 Q3 — Alternate path (Bloom: Evaluate)]
...
→ [Module 04 — Quick Reference Card](../04_quick_reference_card/): 지금까지의 모든 모듈을 면접/디버그용 1 페이지 치트시트로 정리. EL × NS 매트릭스, world switch, 5 축 인프라, boot stage, anti-rollback 의 빠른 참조.

[퀴즈 풀어보기 →](../quiz/03_secure_boot_connection_quiz/)
