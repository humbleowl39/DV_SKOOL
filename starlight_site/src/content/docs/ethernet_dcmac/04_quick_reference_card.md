...
:::
:::note[사전 지식]
- [Module 01](../01_ethernet_fundamentals/) — frame, MAC vs PHY, FCS 범위
- [Module 02](../02_dcmac_architecture/) — DCMAC 5 블록, AXI-S/Segmented IF
- [Module 03](../03_dcmac_dv_methodology/) — UVM env, 4 검증 축, RAL/SVA/coverage
:::
---
...
:::caution[실무 주의점 — IFG underrun + EEE 진입 타이밍 충돌]
...
:::tip[🤔 Q1 — Mode 변경 비용 (Bloom: Analyze)]
...
3 모듈 + Quick Ref 완료. → [퀴즈](../quiz/) · [용어집](../glossary/) · 다음: [TOE](../../toe/), [UVM](../../uvm/).
