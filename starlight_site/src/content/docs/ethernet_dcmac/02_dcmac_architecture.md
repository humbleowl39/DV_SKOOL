---
pagefind: false
title: "Module 02 — DCMAC Architecture"
---
...
:::
:::note[사전 지식]
- [Module 01](../01_ethernet_fundamentals/) — Frame 구조, FCS, MAC vs PHY 분담
...
:::caution[실무 주의점 — Lane Skew / Swap 미검증으로 인한 silent 링크 실패]
...
:::
:::tip[🤔 Q2 — Multi-lane race (Bloom: Analyze)]
...
:::
:::tip[🤔 Q3 — 모드 전환 검증 (Bloom: Evaluate)]
...
→ [Module 03 — DCMAC DV Methodology](../03_dcmac_dv_methodology/): 이 5 블록 위에 UVM 환경을 어떻게 얹는지. AXI-S agent + Line agent + scoreboard + RAL + SVA + coverage 의 전체 설계.

[퀴즈 풀어보기 →](../quiz/02_dcmac_architecture_quiz/)
