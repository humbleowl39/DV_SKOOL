...
**Internal (HDG)**
- `wiki/common/ras_spec.md` — §2 (1) Reliability: ECC(SEC-DED, 1-bit 정정/2-bit 검출), parity; (2) Availability: data poisoning(deferred error, Poison Bit 전파, 소비 시점 exception)
