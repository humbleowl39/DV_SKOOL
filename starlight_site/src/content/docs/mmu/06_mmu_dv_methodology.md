---
title: "Module 06 — MMU DV Methodology"
---
...
:::
:::note[사전 지식]
- [Module 01-05](../01_mmu_fundamentals/) MMU 전반
...
:::caution[실무 주의점 — Page Walk 중 중간 레벨 PTE Fault 미검증]
...
:::tip[🤔 Q1 — Thin VIP 메모리 분석 (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — SVA + Coverage 짝 (Bloom: Evaluate)]
...
- 📝 [**Module 06 퀴즈**](../quiz/06_mmu_dv_methodology_quiz/)
- ➡️ [**Module 07 — Quick Reference Card**](../07_quick_reference_card/): 면접 / 디버그 / 코드 리뷰 시 _빠른 참조_ 카드.
