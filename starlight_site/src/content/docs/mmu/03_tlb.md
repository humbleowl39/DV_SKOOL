...
:::
:::note[사전 지식]
- [Module 01-02](../01_mmu_fundamentals/) (VA → PA 변환, multi-level walk)
...
:::caution[실무 주의점 — TLB Shootdown 순서 오류로 stale 변환 사용]
...
:::tip[🤔 Q1 — TLB miss 의 latency (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — TLB shootdown 순서 (Bloom: Analyze)]
...
- 📝 [**Module 03 퀴즈**](../quiz/03_tlb_quiz/)
- ➡️ [**Module 04 — IOMMU / SMMU**](../04_iommu_smmu/): CPU 가 아닌 _device_ 도 같은 TLB 게임을 하지만, StreamID / SubstreamID / 비동기 page fault 가 추가됨.
