...
:::caution[실무 주의점 — Congestion Window와 CUBIC 상태 불일치]
...
:::tip[🤔 Q1 — Reactive vs Passive agent (Bloom: Apply)]
...
:::
:::tip[🤔 Q2 — State machine coverage (Bloom: Analyze)]
...
→ [Module 05 — Quick Reference Card](../05_quick_reference_card/): 5 모듈의 핵심을 한 장으로. 면접 골든 룰 + 이력서 연결 + TCP 핵심 수치.

- 📝 [**Module 04 퀴즈**](../quiz/04_toe_dv_methodology_quiz/)
