...
> ISO 11179 형식 정의. Definition은 *concept that IS* (단일 문장). Example은 별도 필드. 한국어 미러: Glossary (KO).
...
<p class="glossary-field"><strong>See also.</strong> <a href="../01_dram_jedec_landscape/#2-dram-셀의-본질--1t1c와-destructive-read">Ch01 §2</a></p>
</div>
