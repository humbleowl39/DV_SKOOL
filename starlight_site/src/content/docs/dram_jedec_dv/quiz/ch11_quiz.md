...
:::tip[Q1. DDR5 controller IP의 V-Plan에서 *가장 먼저* 정의해야 할 것은? `(Evaluate)`]
- A. UVM TB 코드
...
:::tip[Q2. UVM driver 가 DDR5 2-cycle command 발급 시 핵심 동작은? `(Understand)`]
...
:::tip[Q4. LPDDR5 변형 적용 시 *추가/변경*되는 컴포넌트로 옳지 *않은* 것은? `(Remember)`]
- A. WCK_t/c 핀 추가
- B. CBT 시퀀스 추가
- C. *Bank Group 4개로 축소*
...
:::tip[Q7. DDR5 controller IP 검증의 *Coverage Report* 결과:]
