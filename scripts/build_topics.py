...
def main() -> None:
    ...
    SKIP = {"uvm", "amba_protocols", "formal_verification", "mmu", "dram_ddr", "ufs_hci", "ethernet_dcmac", "toe", "soc_integration_cctv", "soc_secure_boot", "arm_security", "virtualization", "automotive_cybersecurity"}
