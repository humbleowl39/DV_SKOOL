# Ch12. UVM × RNM Integration — Env · Agent · Sequence · Scoreboard
...
- 이전: [Ch11. 도구 지형](11_tools_ecosystem.md)
- 함정·debug·coverage 전략: [Ch10. RNM/AMS 검증 방법론](10_verification_methodology.md)
- 언어 도구 (real · nettype · SVA on real): [Ch05. RNM with SystemVerilog](05_rnm_systemverilog.md)
- 다음: [Appendix D. Analog IP Catalogue](appendix_d_analog_ip_catalogue.md)
- 퀴즈: [Ch12 퀴즈](quiz/ch12_quiz.md)
