...
<p class="glossary-field"><strong>참조.</strong> <a href="01_dram_jedec_landscape.md">Ch01</a></p>
</div>
...
<div class="chapter-nav">
  <a class="nav-prev" href="appendix_b_glossary.md">
    <div class="nav-label">← 이전</div>
    <div class="nav-title">Glossary (EN)</div>
  </a>
  <a class="nav-next" href="appendix_c_sva_coverage_examples.md">
