...
!!! info "사전 지식"
    - [Module 01-07](01_virtualization_fundamentals.md)

!!! tip "💡 이해를 위한 비유"
    **Virtualization 마스터 = trade-off 의 모든 축 인지** ≈ **건축가 — 객실 / 침대 / 호텔 / 도시의 모든 옵션의 장단을 꿰뚫음**
...
!!! danger "❓ 흔한 오해"
    **오해**: Virtualization 은 항상 overhead 가 있다

    **실제**: VT-x + EPT + IOMMU 등 HW assist 로 modern virtualization 의 overhead 는 5-10% 수준. 워크로드별로 측정 필수.

    **왜 헷갈리는가**: 초기 SW-only 시대의 30%+ overhead 인상이 남아 있어서. Modern 은 다름.
