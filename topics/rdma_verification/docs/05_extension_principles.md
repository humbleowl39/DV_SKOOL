...
# unparsed: TS["vrdma_top_sequence<br/>stateless functions"]
# unparsed: SQ["vrdma_sequencer<br/>stateful:<br/>wc_error_status[qp][$]<br/>debug_wc_flag[qp][$]<br/>outstanding 카운터"]
TS { style.stroke: "#1a73e8"; style.stroke-width: 2; style.stroke-dash: 4 }
SQ { style.stroke: "#137333"; style.stroke-width: 3 }
TS -> SQ: "uses"
```
