...
# unparsed: IN["DUT 의 C2H DMA 트랜잭션"]
Q1: "① addr ∈\nm_qp_tracker[*][*].pa_queue ?" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
# unparsed: Q2["② 어느 QP 의 PA 인가?<br/>(cross-QP 충돌 검사)"]
Q3: "③ ordering 검사\nRC: idx==0\nOPS/SR: idx 범위 내" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
Q4: "④ DUT len ≤\ncmd.transfer_size ?" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
# unparsed: OK["OK — 통과"]
GATE: "is_err_qp_registered\n[node][qp] ?" { shape: diamond; style.stroke: "#b8860b"; style.stroke-width: 2 }
# unparsed: SKIP["silently skip"]
# unparsed: FATAL["F-C2H-MATCH-0001/0002/0003/0004"]
# unparsed: DUMP["W-C2H-MATCH-0001~0004<br/>(unprocessed PA dump)"]
IN -> Q1
Q1 -> Q2: "yes"
Q2 -> Q3
Q3 -> Q4
OK { style.stroke: "#137333"; style.stroke-width: 2 }
Q4 -> OK: "ok"
Q1 -> GATE: "no"
Q4 -> GATE: "fail"
SKIP { style.stroke: "#137333"; style.stroke-width: 2 }
GATE -> SKIP: "yes"
FATAL { style.stroke: "#c0392b"; style.stroke-width: 3 }
DUMP { style.stroke: "#c0392b"; style.stroke-width: 3 }
GATE -> FATAL: "no"
FATAL -> DUMP
```
